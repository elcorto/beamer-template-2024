...
% Default is HUGE frame titles with Hermann font that waste a lot of space.
%%\hgfusenormalframetitle
...
% This is annoying as it increases build time and makes slides.pdf huge for no
% reason.
